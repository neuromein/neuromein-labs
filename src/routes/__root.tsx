...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "NEUROMEIN - Андрей Майнгардт | AI-стратег" },
      { property: "og:title", content: "NEUROMEIN - Андрей Майнгардт | AI-стратег" },
      { name: "twitter:title", content: "NEUROMEIN - Андрей Майнгардт | AI-стратег" },
      { name: "description", content: "Как ИИ меняет профессии и бизнес. Исследования, прогнозы, аналитические разборы о трансформации рынка труда в 2026–2030." },
      { property: "og:description", content: "Как ИИ меняет профессии и бизнес. Исследования, прогнозы, аналитические разборы о трансформации рынка труда в 2026–2030." },
      { name: "twitter:description", content: "Как ИИ меняет профессии и бизнес. Исследования, прогнозы, аналитические разборы о трансформации рынка труда в 2026–2030." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/86a8eb51-aa59-46a4-ac7a-bc29f8918368/id-preview-bc0b7de5--3bb945ca-b384-4387-b585-b52c1d99075b.lovable.app-1776549855928.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/86a8eb51-aa59-46a4-ac7a-bc29f8918368/id-preview-bc0b7de5--3bb945ca-b384-4387-b585-b52c1d99075b.lovable.app-1776549855928.png" },
    ],
    links: [
