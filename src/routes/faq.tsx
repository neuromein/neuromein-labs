...
const FAQ = [
  ...
  },
  {
    ...
    a: "AI-стратег и аналитик, основатель аналитического ресурса NEUROMEIN (43 000+ подписчиков), AI Strategist в компании WMT AI. Автор исследования «Тихая замена» и отчёта «ИИ в 2025 и прогнозы на 2026». Специализируется на анализе влияния ИИ на рынок труда и стратегическом внедрении ИИ в бизнес.",
  },
  {
