...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "Андрей Майнгардт — эксперт по влиянию ИИ на рынок труда, автор «Тихой замены»" },
      {
        name: "description",
        content:
          "Андрей Майнгардт — эксперт по влиянию ИИ на бизнес-процессы и рынок труда, автор исследования «Тихая замена». Аналитика, исследования и проверяемые прогнозы о трансформации рынка труда в горизонте 2026–2030.",
      },
      { property: "og:title", content: "Андрей Майнгардт — эксперт по влиянию ИИ на рынок труда, автор «Тихой замены»" },
      {
