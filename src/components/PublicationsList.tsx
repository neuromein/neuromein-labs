              ...
              <div className="flex flex-col gap-5 p-5 lg:p-6">
                ...
                <div className="flex flex-wrap items-center gap-2.5">
                  <Link
                    to="/blog/$slug"
                    params={{ slug: p.slug }}
                    className="inline-flex h-10 items-center gap-2 rounded-full border-[0.5px] border-border-strong bg-bg-card/70 px-4 text-[13px] font-medium text-text-secondary transition-colors hover:border-brand/50 hover:text-text-primary"
                  >
                  ...
                  {p.telegramUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex h-10 items-center gap-2 rounded-full border-[0.5px] border-border-strong bg-bg-card/70 px-4 text-[13px] font-medium text-brand transition-colors hover:border-brand/50 hover:text-text-primary"
                    >
